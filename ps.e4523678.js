...
(function ($PS) {
  ...
  var printColor = function printColor(v) {
    if (v instanceof RGB) {
...
(function ($PS) {
  ...
  var viewBox = function viewBox(x_) {
    return function (y_) {
      return function (w) {
        return function (h_) {
  ...
  var classes = function () {
    var $136 = Halogen_HTML_Properties.attr("class");
    var $137 = Data_String_Common.joinWith(" ");
    var $138 = Safe_Coerce.coerce();
    return function ($139) {
...
(function ($PS) {
  ...
  var wheelOfFifths = Halogen_HTML_Elements.div([])([]);

  var keyboard = function () {
    var whiteKeys = Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(1)(30))(function (i) {
      return Halogen_Svg_Elements.rect([Halogen_Svg_Attributes.x(Data_Int.toNumber(i) * 3.0), Halogen_Svg_Attributes.y(5.0), Halogen_Svg_Attributes.height(10.0), Halogen_Svg_Attributes.width(3.0), Halogen_Svg_Attributes.strokeWidth(0.1), Halogen_Svg_Attributes.stroke(new Halogen_Svg_Attributes_Color.RGB(0, 0, 0)), Halogen_Svg_Attributes.fill(new Halogen_Svg_Attributes_Color.RGB(255, 255, 255))]);
    });
    var blackKeys = Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.filter(function (k) {
      var rem = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(k)(7);
      return rem !== 3 && rem !== 6;
    })(Data_Array.range(1)(30)))(function (i) {
      return Halogen_Svg_Elements.rect([Halogen_Svg_Attributes.x(2.2 + Data_Int.toNumber(i) * 3.0), Halogen_Svg_Attributes.y(5.0), Halogen_Svg_Attributes.height(6.0), Halogen_Svg_Attributes.width(1.5), Halogen_Svg_Attributes.strokeWidth(0.1), Halogen_Svg_Attributes.stroke(new Halogen_Svg_Attributes_Color.RGB(0, 0, 0)), Halogen_Svg_Attributes.fill(new Halogen_Svg_Attributes_Color.RGB(0, 0, 0))]);
    });
    return Halogen_Svg_Elements.svg([Halogen_Svg_Attributes.classes(["svg-piano"]), Halogen_Svg_Attributes.viewBox(0.0)(0.0)(100.0)(100.0)])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(whiteKeys)(blackKeys));
  }();

  var pianoPage = Halogen_HTML_Elements.div([])([keyboard, wheelOfFifths]); // This is a little helper to save some space

  var cn = function cn($0) {
    return Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName($0));
  };

  var mainPage = Halogen_HTML_Elements.div([cn("flex flex-wrap justify-center content-center align-center w-screen h-screen")])([Halogen_HTML_Elements.a([Halogen_HTML_Properties.href("#/play"), cn("rounded-lg px-10 py-10 block bg-red-500 text-5xl")])([Halogen_HTML_Core.text("Play")])]);
  exports["mainPage"] = mainPage;
  exports["pianoPage"] = pianoPage;
})(PS);
...
(function ($PS) {
  ...
  var genericPage = new Data_Generic_Rep.Generic(function (x) {
    ...
    ;
    throw new Error("Failed pattern match at Types (line 11, column 1 - line 11, column 46): " + [x.constructor.name]);
  }, function (x) {
...
(function ($PS) {
  ...
  var Types = $PS["Types"];
  var routeCodec = Routing_Duplex.root(Routing_Duplex.optional(Routing_Duplex_Generic.sum(Types.genericPage)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
    return "Main";
  ...
  var setUrlHash = function setUrlHash(dictMonadAff) {
    var $1 = Effect_Class.liftEffect(dictMonadAff.MonadEffect0());
    var $2 = Routing_Duplex.print(routeCodec);
    return function ($3) {
      return $1(Routing_Hash.setHash($2($3)));
    };
  };

  var listenForUrlHashChanges = function listenForUrlHashChanges(halogenIO) {
    return Routing_Hash.matchesWith(Data_Foldable.foldableEither)(Routing_Duplex.parse(routeCodec))(function (old) {
      return function ($$new) {
  ...
  exports["listenForUrlHashChanges"] = listenForUrlHashChanges;
...
(function ($PS) {
  ...
  var getBaseUrl = function __do() {
    var win = Web_HTML.window();
    var loc = Web_HTML_Window.location(win)();
    var prot = Web_HTML_Location.protocol(loc)();
    var host = Web_HTML_Location.hostname(loc)();
    var path = Web_HTML_Location.pathname(loc)();
  ...
  var component = function () {
    var render = function render(state) {
      ...
      if (state.page instanceof Types.Play) {
        return Pages.pianoPage;
      }

      ;
      throw new Error("Failed pattern match at Main (line 80, column 18 - line 82, column 22): " + [state.page.constructor.name]);
    };
    ...
    var handleQuery = function handleQuery(v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Debug.traceM()(Halogen_Query_HalogenM.monadHalogenM)(v.value0))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Types.eqPage))(new Data_Maybe.Just(v1.page))(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
            ...
            ;
            $9.page = Data_Maybe.fromMaybe(Types.Main.value)(v.value0);
            return $9;
          })))(function () {
    ...
    var handleAction = function handleAction(v) {
      if (v instanceof Types.SwitchPage) {
        return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
          return Routes.setUrlHash(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(new Data_Maybe.Just(v.value0));
        });
      }
      ...
      ;
      throw new Error("Failed pattern match at Main (line 73, column 18 - line 77, column 28): " + [v.constructor.name]);
    };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
    return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(getBaseUrl))(function (baseUrl) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Debug.traceM()(Effect_Aff.monadAff)(baseUrl))(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(body))(function (halogenIO) {
            return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routes.listenForUrlHashChanges(halogenIO)))(function (canceller) {
...
PS["Main"].main();
},{}],"../../../../../nix/store/9w4mrzs0ajjfdy8wmgrg44jcd03rw6qv-node_parcel-bundler-1.12.5/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/piano/ps.e4523678.js.map