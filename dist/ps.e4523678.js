...
(function ($PS) {
  ...
  */
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex.optional(Routing_Duplex_Generic.sum(Types.genericPage)(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
    return "Main";
  ...
  var listenForUrlHashChanges = function listenForUrlHashChanges(halogenIO) {
    return Routing_Hash.matchesWith(Data_Foldable.foldableEither)(function () {
      var $1 = Routing_Duplex.parse(routeCodec);
      return function ($2) {
        return $1(stripBang($2));
      };
    }())(function (old) {
      return function ($$new) {
  ...
  var setUrlHash = function setUrlHash(dictMonadAff) {
    var $3 = Effect_Class.liftEffect(dictMonadAff.MonadEffect0());
    var $4 = Routing_Duplex.print(routeCodec);
    return function ($5) {
      return $3(Routing_Hash.setHash(addBang($4($5))));
    };
  };
...
(function ($PS) {
  ...
  var component = function () {
    ...
    var handleAction = function handleAction(v) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 57, column 18 - line 61, column 28): " + [v.constructor.name]);
    };
