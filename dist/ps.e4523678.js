...
(function ($PS) {
  ...
  var stripBang = function stripBang(str) {
    return Data_Maybe.fromMaybe(str)(Data_String_CodeUnits.stripPrefix("!")(str));
  };
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex.optional(Routing_Duplex_Generic.sum(genericPage)(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
    return "Main";
  ...
  var listenForUrlHashChanges = function listenForUrlHashChanges(halogenIO) {
    return Routing_Hash.matchesWith(Data_Foldable.foldableEither)(function () {
      var $25 = Routing_Duplex.parse(routeCodec);
      return function ($26) {
        return $25(stripBang($26));
      };
    }())(function (old) {
      return function ($$new) {
        return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Maybe.eqMaybe(eqPage)))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.mkTell(Navigate.create($$new)))));
      };
    });
  };

  var cn = function cn($27) {
    return Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName($27));
  };

  var mainPage = Halogen_HTML_Elements.div([cn("flex flex-wrap justify-center content-center align-center w-screen h-screen")])([Halogen_HTML_Elements.a([cn("rounded-lg px-10 py-10 block bg-red-500 text-5xl")])([Halogen_HTML_Core.text("Play")])]);
  var addBang = Data_Semigroup.append(Data_Semigroup.semigroupString)("!");

  var setUrlHash = function setUrlHash(dictMonadAff) {
    var $28 = Effect_Class.liftEffect(dictMonadAff.MonadEffect0());
    var $29 = Routing_Duplex.print(routeCodec);
    return function ($30) {
      return $28(Routing_Hash.setHash(addBang($29($30))));
    };
  };
  ...
  var component = function () {
    ...
    var handleQuery = function handleQuery(v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(eqPage))(new Data_Maybe.Just(v1.page))(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
          var $17 = {};
          ...
          ;
          $17.page = Data_Maybe.fromMaybe(Main.value)(v.value0);
          return $17;
        })))(function () {
    ...
    var handleAction = function handleAction(v) {
      if (v instanceof SwitchPage) {
        return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
          return setUrlHash(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(new Data_Maybe.Just(v.value0));
        });
      }
      ...
      ;
      throw new Error("Failed pattern match at Main (line 108, column 18 - line 112, column 28): " + [v.constructor.name]);
    };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
    return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(body))(function (halogenIO) {
        return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(listenForUrlHashChanges(halogenIO)))(function (canceller) {
  ...
  exports["addBang"] = addBang;
  exports["stripBang"] = stripBang;
  exports["main"] = main;
